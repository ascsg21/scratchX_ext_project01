...
(function(ext) {
    ...
    ext.getKoToEnTranslation = function(str, callback) {
      ...
      //     success: function(data) {callback(data.legnth);}, // 요청 완료 시
      //     error: function(data) {callback(jqXHR);}, // 요청 실패.
      //     complete: function(data) {callback('ddd');} // 요청의 실패, 성공과 상관 없이 완료 될 경우 호출
      // });
